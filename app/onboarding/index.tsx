...
const SLIDES: SlideItem[] = [
  {
    ...
    content: (
      <OnBoardingItem
        ...
        description={
          "Thông tin địa điểm chi tiết, hình ảnh sinh động và đánh giá tin cậy giúp trải nghiệm khám phá trở nên trọn vẹn"
        }
  ...
  },
  {
    ...
    content: (
      <OnBoardingItem
        ...
        description={
          "Công nghệ AI gợi ý các địa điểm phù hợp với sở thích của bạn, tối ưu hóa lịch trình giúp bạn tiết kiệm thời gian và chi phí"
        }
  ...
  },
  {
    ...
    content: (
      <OnBoardingItem
        ...
        description={
          "Dễ dàng chia sẻ lịch trình đã tạo với mọi người, cùng nhau lên kế hoạch và tận hưởng huyến đi hoàn hảo"
        }
...
function PaginationDot({ index, scrollX }: DotProps) {
  ...
  return <Dot style={animatedDotStyle} />;
}
